...
# data specifications
parser.add_argument("--dir_image", type=str, default=r"E:\AOT-GAN-for-Inpainting-finetune\examples\face\image", help="image dataset directory")
...
parser.add_argument("--pre_train", type=str, default=r"E:\AOT-GAN-for-Inpainting-finetune\experiments\v3\G_latest.pt", help="path to pretrained models")
